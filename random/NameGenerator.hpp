...
namespace pg
{
        ...
        public:
            ...
            std::string operator()()
            {
                ...
                for(unsigned int i = 0; i < syllableCount; ++i)
                {
                    ...
                    {
                        throw std::runtime_error("NameGenerator::operator()  "
                                                 "Index out of bounds");
                    }
                    ret += syllables[index];
                }
    ...
    pg::NameGenerator<DistC, DistI> CreateNameGenerator(
            ...
            pg::Distribution<unsigned int, DistI> &sylIndDist)
    {
        return pg::NameGenerator<DistC, DistI>(generator, syl, sylCntDist,
                                               sylIndDist);
    }

    pg::NameGenerator<std::uniform_int_distribution,
